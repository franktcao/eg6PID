...
class EG5_test {
   ...
   TH1D			  *h1phi;
	...
	static const int	h2length;
	static const int	h1length;
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     Show(Long64_t entry = -1);
	...
	vector<vector<float>> readDataTable(string fileName, const int bufSize,  const int nCols);
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Double_t getCorrectedSampFrac(Int_t irun, Int_t ievent, Int_t sector)
{
   ...
   if (sector < 1 || sector > 6)
	...
	double file = getInterpFileN(irun, ievent);
	if (file < 0) {cout << "file < 0" <<endl; return -999;}
